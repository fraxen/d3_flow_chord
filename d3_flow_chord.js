...
// Initialize diagram
	...
	config.watchKeypress = 'watchKeypress' in config ? config.watchKeypress : true;
		...
		function draw(year, countries, callback) {
			...
			/* Execute callback after all transitions - using 1.1 just to be on the safe side! */
			setTimeout( callback, config.animationDuration * 1.1 );
		}
